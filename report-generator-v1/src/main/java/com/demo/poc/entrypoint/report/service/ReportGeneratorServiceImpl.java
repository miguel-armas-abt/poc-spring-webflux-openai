...
public class ReportGeneratorServiceImpl implements ReportGeneratorService {
  ...
  @Override
  public Mono<byte[]> generateReport(Map<String, String> headers, ReportRequestDto reportRequest) {
    ...
    return jsonSerializer.readElementFromFile(promptFilePath, Prompt.class)
        .flatMap(prompt -> openAIRepository.analyzeImage(headers, prompt.buildPrompt(), reportRequest.getImageUrl()))
